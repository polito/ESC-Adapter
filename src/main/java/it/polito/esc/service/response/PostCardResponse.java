...
public class PostCardResponse extends EscResponse<CardView> {
	...
	public String toString() {
		return "PostCardResponse [data=" + data + ", code=" + statusCode + ", escErrorResponse=" + escErrorResponse
				+ "]";
	}

	@Override
	public EscResponse<CardView> clone() {
		PostCardResponse clone = new PostCardResponse();
