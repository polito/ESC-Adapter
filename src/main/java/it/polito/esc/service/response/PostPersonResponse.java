...
public class PostPersonResponse extends EscResponse<PersonView> {

	private static final long serialVersionUID = 4121992041220241604L;
	...
	public EscResponse<PersonView> clone() {
		PostPersonResponse clone = new PostPersonResponse();
